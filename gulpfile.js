...
gulp.task('js', function () {
	var bundler = browserify('./src/js/build.js', { debug: true }).transform( babelify, { presets: [ 'es2015' ] } );
...
gulp.task('jsProd', function () {
	var bundler = browserify('./src/js/build.js', { debug: false }).transform( babelify, { presets: [ 'es2015' ] } );
